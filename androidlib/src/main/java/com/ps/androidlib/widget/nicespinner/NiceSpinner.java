...
public class NiceSpinner extends TextView {
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (adapter != null) {
                setText(adapter.getItemInDataset(selectedIndex).getName());
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundChecked = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundChecked,R.drawable.checked);
        setBackgroundResource(backgroundChecked);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setText(adapter.getItemInDataset(position).getName());
                dismissDropDown();
            }
        });
    ...
    public <T> void attachDataSource(@NonNull List<SpinnerModel> dataset) {
