...
public class PickerUtils {
     ...
     */
    public static void alertTimerPicker(Context context, TimePickerView.Type type, String curDate, final String format, final TimerPickerCallBack callBack) {
        TimePickerView pvTime = new TimePickerView(context, type);
        final SimpleDateFormat sdf = new SimpleDateFormat(format);
        //控制时间范围
        Calendar calendar = Calendar.getInstance();
        pvTime.setRange(1900, calendar.get(Calendar.YEAR) + 10);
