...
//        }
        ...
        holder.tabUnread = (TextView) view.findViewById(R.id.tv_unread);
...
//        }
     ...
     * @param show
     */
    public void setUnreadShowStatus(int index,boolean show){
        if (index >= 0 && index < mViewHolderList.size()) {
            ViewHolder holder = mViewHolderList.get(index);
            holder.tabUnread.setVisibility(show ? VISIBLE : GONE);
        }
    }
